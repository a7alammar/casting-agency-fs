...
class CastingAgencyTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.casting_assistant_header = os.environ['CASTING_ASSISTANT_HEADER']


        self.casting_director_header = os.environ['CASTING_DIRECTOR_HEADER']


        self.executive_producer_header = os.environ['EXECUTIVE_PRODUCER_HEADER']
